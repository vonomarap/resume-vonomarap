export const profiles = {
  ru: {
    ...
    aboutHighlights: [
      ...
      },
      {
        title: "Образование",
        description:
          "Окончил Ростовский колледж связи и информатики (РКСИ) в 2024 году по специальности техник-программист.",
      },
      {
        title: "Базы данных",
        description:
    ...
    developerSnapshot: {
      ...
      lines: [
        ...
        "tools: Python, Git",
        "status: Looking for a junior backend role",
      ],
  ...
  en: {
    metaTitle: "Vlad | Junior Java / Spring Backend Developer",
    metaDescription:
      "Resume website for Vlad, a junior backend developer focused on Java, Spring, SQL, and relational databases.",
    firstName: "Vlad",
    fullName: "Vlad",
    role: "Junior Java / Spring Backend Developer",
    headline:
    ...
    aboutHighlights: [
      ...
      },
      {
        title: "Education",
        description:
          "Graduated from Rostov College of Communications and Informatics (RKSI) in 2024 with a technician-programmer qualification.",
      },
      {
        title: "Databases",
        description:
    ...
    developerSnapshot: {
      ...
      title: "backend-profile.ts",
      availabilityLabel: "Open to junior opportunities",
      lines: [
        "stack: Java, Spring Framework, SQL",
        "databases: MySQL, PostgreSQL",
        "tools: Python, Git",
